...
namespace AAEmu.Game.Models.Game.Skills.Effects
{
    public class OpenPortalEffect : EffectTemplate
    {
            ...
            Skill skill, SkillObject skillObject, DateTime time)
        {
            ...
            Log.Debug("OpenPortalEffect, Owner: {0}, PortalId: {1}, Type: {5}, X: {2}, Y: {3}, Z:{4}", portalOwner.Name, portalInfo.Id, portalInfo.X, portalInfo.Y, portalInfo.Z, portalInfo.Type);
